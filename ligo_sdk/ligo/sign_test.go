...
"LIGONRy59BQPvKdKGhh52oa7LiYkr69judc7oe"
...

	{
	  ...
	  "operations": [[
	      10,{
	        ...
	        "crosschain_type": "ETH",
	        "addr": "LIGONRy59BQPvKdKGhh52oa7LiYkr69judc7oe",
...
func testBtcSignAddr(t *testing.T) {
	var (
		...
		exp  = "H/wTWGMMH6F687Zjj2N48YAwMYmMR9ZN2EDk/kmqEd/lBszu8Ligoijg8lakUQy6EChkTTRPh6JksY7V/+VG7ykuc="
	)
...
func testLtcSignAddr(t *testing.T) {
	var ltcAddres = []struct {
	...
	},
		{
			...
			exp:  "H6zfPRpOp/on4gS/2JcpbHo9Up8cj4I+1zIYng64/RUzOqo0allqC7J+ligoStQY+E7+Ze9fZdac+KuMwBmXjvCww=",
		},
	}
